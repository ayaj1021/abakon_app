...
import 'package:abakon/presentation/features/reset_password/view/reset_password.dart';
...
class ForgotPasswordOTPVerification<T> extends ConsumerStatefulWidget {
  const ForgotPasswordOTPVerification({required this.email, super.key});

  final String email;

  @override
  ConsumerState<ForgotPasswordOTPVerification<T>> createState() =>
      _OTPVerificationState<T>();
}

class _OTPVerificationState<T>
    extends ConsumerState<ForgotPasswordOTPVerification<T>> {
            ...
            Navigator.push(
                ...
                MaterialPageRoute(
                    builder: (_) => ResetPassword(
                        _otpController.text.trim(), widget.email)));

            //context.pushReplacementNamed(ResetPassword.routeName);
          },
        );
  }
